    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 text-center perspective-[1000px]">
        ...
        >
          ...
          protection layer for modern commerce. Stop card testing and
          chargebacks before they hit your balance.
        </p>
...
function FloatingCard({
  ...
  return (
    ...
    >
      ...
      <span className={cn("text-xs font-bold font-mono tracking-tight", color)}>
        {value}
      </span>
    </div>
  );
